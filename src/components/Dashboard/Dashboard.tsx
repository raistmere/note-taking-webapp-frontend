    ...
    const displayContentView = () => {
        ...
        switch (view) {
            ...
            case View.CHANGEPASSWORD:
                ...
                return <ChangePassword viewSettings={viewSettings}/>
            default:
